...
public class PetStoreController {
    ...
    @PutMapping("/petstore/{petStoreId}/employee/{employeeId}")
	...
	public Map<String, String> deletePetStoreById(
		...
		return Map.of("message", "Successfully deletion of pet store with ID=" + petStoreId);
	}
